...
const nextSeasonPlans = [
  ['Menos de 50', '½ día', '2 días', '$37.500', '$150.000'],
  ['De 50 a 100', '1 día', '3 días', '$75.000', '$225.000'],
  ['De 100 a 150', '1½ día', '4 días', '$112.500', '$300.000'],
  ['De 150 a 200', '2 días', '5 días', '$150.000', '$375.000'],
  ['Más de 200', '2½ días', '6 días', '$187.500', '$450.000'],
];
    ...
    <main className="overflow-x-clip bg-[#fffaf0] font-sans text-[#174d4b] selection:bg-[#f0512d] selection:text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-[#174d4b]/10 bg-[#fffaf0]/95 shadow-[0_8px_24px_rgba(14,53,53,0.1)] backdrop-blur-md">
          <div className="mx-auto hidden max-w-7xl items-center justify-between px-5 py-3 text-xs font-bold text-[#506c68] sm:flex sm:px-8 lg:px-12">
            ...
            <div className="flex items-center gap-5"><a href="#precio" className="hover:text-[#f0512d]">Abono</a><a href="#fundadores" className="hover:text-[#f0512d]">Fundadores</a><LoginLink className="hover:text-[#f0512d]" /></div>
          </div>
      ...
      <div id="precio" className="scroll-mt-40 sm:scroll-mt-44 mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
        <PricingCalculator />
      </div>
